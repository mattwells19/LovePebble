    ...
    <Box width="full" display="flex" flexDirection="column" gap="4">
      ...
      <FormControl display="flex" flexDirection="column">
        ...
        <Box textAlign="center">
          {players.size < 2 && <FormHelperText>Need at least 2 players to start the game.</FormHelperText>}
          {players.size > 6 && <FormHelperText>Can only support a maximum of 6 players.</FormHelperText>}
        </Box>
      </FormControl>
    </Box>
  );
